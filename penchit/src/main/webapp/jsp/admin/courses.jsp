...
<div class="btn-group" uib-dropdown uib-keyboard-nav style="margin:0px 0px 0px 300px">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
          <input class="form-control" id="courseName" ng-model="courseName" ng-click="removeErrorMsgs('courseNameError');" placeholder="Course Name">
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
			<textarea class="form-control custom-control" id="courseDesc" ng-model="courseDesc" ng-click="removeErrorMsgs('courseDescError');"  rows="3" style="resize:block" placeholder="Course Description"></textarea>   
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
          <textarea class="form-control custom-control" rows="3" id="courseSyllabus" ng-model="courseSyllabus" ng-click="removeErrorMsgs('courseSyllabusError');" style="resize:block" placeholder="Course Syllabus"></textarea>   
        </div>
        <div style="padding-top:5px;color:red;display:none" id="courseSyllabusError" >Please enter the Course Syllabus</div>
      </div>
      <div class="form-group">
        <label for="group2" class="col-sm-3 control-label">Course Logo</label>
        <div class="col-sm-5">
          <input type="file" class="filestyle" onchange="angular.element(this).scope().setTitle(this)" id="courseLogo" ng-model="courseLogo" ng-click="removeErrorMsgs('courseLogoError');" data-placeholder="No file">
          <input>  
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
          <input class="form-control" id="versionId" ng-model="versionId" placeholder="Version" ng-click="removeErrorMsgs('versionError');">
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
          <input class="form-control" id="coursePrice" ng-model="coursePrice" placeholder="Course Price" ng-click="removeErrorMsgs('coursePriceError');">
        </div>
